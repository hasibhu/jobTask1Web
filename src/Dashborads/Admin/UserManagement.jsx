...
const UserManagement = () => {
    ...
    //     // Determine if currentBalance should be updated
    //     const updateData = { status: newStatus };
        

    //     try {
    //         const { data } = await axiosPublic.patch(`/users/status/${user._id}`, updateData);
                            ...
                            <tr key={user._id} className='text-center'>
                                ...
                                <td>
                                    <button
                                        ...
                                        className={`w-[66px] rounded-2xl h-5 ${user.status === 'active' ? 'bg-green-500' : 'bg-yellow-600'}`}
                                    >
